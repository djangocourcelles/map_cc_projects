...
| VIS-04 | Phase 2 | Rayon bulle = 5 paliers (0j→50, <7j→40, <30j→30, <90j→20, ≥90j→12) |
| VIS-05 | Phase 2 | Anneau 3px = phase GSD depuis STATE.md, tireté si absent |
| INT-04 | Phase 2 | WebSocket + chokidar ciblé (STATE.md + COMMIT_EDITMSG) |
